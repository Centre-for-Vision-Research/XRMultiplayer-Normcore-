...
//     private static int playerCounter = 0; // Keeps track of players to assign sequentially
...
//         // Get the next sequential prefab
//         GameObject selectedPrefab = GetSequentialPrefab();
...
//     private GameObject GetSequentialPrefab() {
//         if (avatarPrefabs.Count == 0)
//             return null; // No prefabs available

//         // Select prefab using playerCounter % avatarPrefabs.Count
//         int prefabIndex = playerCounter % avatarPrefabs.Count;

//         // Increment playerCounter for the next player
//         playerCounter++;
